...
git@github.com:bth-mvc/mvc-mosstud.git
```
...
git clone git@github.com:bth-mvc/mvc-mosstud.git
```
...
git clone git@github.com:bth-mvc/mvc-mosstud.git mvc-mosstud_backup
```

I mitt fall så kommer repot att klonas och sparas som `mvc-mosstud_backup`.
